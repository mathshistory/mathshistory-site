...
with open('lektor_mathshistory_otherindexes.py', 'rb') as f:
...
setup(
    ...
    name='lektor-mathshistory-otherindexes',
    ...
    entry_points={
        'lektor.plugins': [
            'mathshistory-otherindexes = lektor_mathshistory_otherindexes:MathshistoryOtherindexesPlugin',
        ]
    }
)
