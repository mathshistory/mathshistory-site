...
with open('lektor_mathshistory_countries.py', 'rb') as f:
...
setup(
    ...
    name='lektor-mathshistory-countries',
    ...
    entry_points={
        'lektor.plugins': [
            'mathshistory-countries = lektor_mathshistory_countries:MathshistoryCountriesPlugin',
        ]
    }
)
